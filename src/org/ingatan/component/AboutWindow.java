...
public class AboutWindow extends JDialog {
    ...
    public AboutWindow() {
        ...
        txtAbout.setRichText("[b][aln]0[!aln][fam]Dialog[!fam][sze]14[!sze][col]51,51,51[!col]Ingatan v1.3.5 (ingatan.org)[br][b][sze]12[!sze]" +
                ...
                "[u]Arrow2D.java[u] from www.geotools.org under LGPL 2.1 - Thankyou, glad not to write my own.[br][br][br]" +
                "Thankyou to Hugh for being my bug hunter.[br]Icons other than those from the silk set are from the Gnome desktop (under GPL2) and Tango set (public domain). [end]");
