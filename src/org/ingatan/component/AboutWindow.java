...
public class AboutWindow extends JDialog {
    ...
    public AboutWindow() {
        ...
        RewardItem logo = new RewardItem("Ingatan 1.5.2", -1, "jar://resources/logo.png");
        ...
        txtAbout.setRichText("[aln]0[!aln][fam]Dialog[!fam][col]51,51,51[!col][sze]12[!sze]" +
                "Hello! If you find this program useful, please let me know. You can contact me at [b]tom.ingatan@gmail.com.[b] " +
                "If you find any bugs or have any suggestions, go to [b]ingatan.org[b] and sumbit a new Issue (you will need a google account), or email me at the address above.[br][br]" +
